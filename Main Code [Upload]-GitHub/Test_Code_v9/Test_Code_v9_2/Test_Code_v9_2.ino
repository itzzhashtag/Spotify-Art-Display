...
void drawClockScene(uint8_t sceneBrightness) {
  ...
  // No valid reading yet (first boot before the initial fetch lands,
  // or the last fetch failed) - leave this area blank rather than
  // drawing "--" / "--", which at this small scale just reads as a
  // couple of stray dots.
